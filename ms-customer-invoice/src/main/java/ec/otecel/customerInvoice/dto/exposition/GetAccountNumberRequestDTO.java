...
public class GetAccountNumberRequestDTO {
    ...
    /**
     * Número de línea
     * Validación: solo dígitos, longitud entre 1 y 16
     */
    @NotNull(message = "El atributo msisdn es obligatorio")
    @Pattern(regexp = "^[0-9]{1,16}$", message = "El atributo msisdn debe contener solo números y tener una longitud entre 1 y 16 caracteres")
