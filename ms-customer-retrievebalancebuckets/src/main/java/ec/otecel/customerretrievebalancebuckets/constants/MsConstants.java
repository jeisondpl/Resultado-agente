 ...
 * 
 */
package ec.otecel.customerretrievebalancebuckets.constants;

public class MsConstants {

	
	public static final String SERVICE = "ms-customer-retrievebalancebuckets";
	public static final String METHOD1 = "customerRetrieveBalanceBuckets";
	...
	public static final String PAYMENTEZ_CORE_DB ="ms-customer-retrievebalancebuckets";
